...
export function GameArenaDecor() {
  return (
    <aside
      className="arena-decor relative flex min-h-0 w-[150px] shrink-0 flex-col gap-2 overflow-y-auto border-r border-[var(--glitch-pink)]/25 bg-[var(--bg-darker)]/80 py-2 px-1.5 sm:w-64 sm:py-3 sm:px-2 lg:w-72"
    >
